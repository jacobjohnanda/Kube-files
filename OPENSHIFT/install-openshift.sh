...
export DOMAIN=${DOMAIN:="scspa0485357001.rtp.openenglab.netapp.com"}
export USERNAME=${USERNAME:="$(whoami)"}
export PASSWORD=${PASSWORD:=netapp}
...
ansible-playbook -i inventory.ini /root/openshift-ansible/playbooks/deploy_cluster.yml
...
echo "******"
echo "* Your conosle is https://$DOMAIN:8443"
echo "* Your username is $USERNAME "
echo "* Your password is $PASSWORD "
echo "*"
echo "* Login using:"
